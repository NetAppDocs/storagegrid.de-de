...
In diesen Themen finden Sie Informationen zu den neuen Funktionen und Verbesserungen in StorageGRID 12.1, dazu, ob Funktionen veraltet oder entfernt wurden, sowie zu Änderungen an den StorageGRID APIs.

* link:how-your-system-is-affected-during-upgrade.html["Auswirkungen des Upgrades auf Ihr System"]
* link:../release-notes/whats-new.html["Neues in StorageGRID 12.1"]
* link:../release-notes/removed-or-deprecated-features.html["Funktionen entfernt oder veraltet"]
* link:../release-notes/changes-to-grid-management-api.html["Änderungen an der Grid-Management-API"]
* link:../release-notes/changes-to-tenant-management-api.html["Änderungen an der Mandantenmanagement-API"]
