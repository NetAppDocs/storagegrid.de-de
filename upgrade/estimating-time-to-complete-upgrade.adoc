...
---
= Schätzen Sie die Zeit für die Durchführung eines StorageGRID Upgrades
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Upgrade anderer Grid-Nodes
 a| 
Die Software auf allen anderen Grid-Knoten wird in der Reihenfolge aktualisiert, in der Sie die Knoten genehmigen.  Ein Admin- oder Gateway-Knoten wird gleichzeitig mit einem Speicherknoten aktualisiert.
 a| 
...
10 Sekunden pro Node oder einige Minuten für das gesamte Grid
 a| 
Das Upgrade auf StorageGRID 12.0 umfasst ein Upgrade der Cassandra-Datenbank.  Nach dem Upgrade von StorageGRID 11.9 auf 12.0 wird ein bis drei Tage lang im Hintergrund eine Aktualisierung des Metadatenformats durchgeführt.  Während dieser Zeit werden bestimmte Wartungsvorgänge, wie beispielsweise Erweiterungen, deaktiviert.
...
== Geschätzte Zeit bis zum Upgrade
...
== Beispiel: Geschätzte Zeit für das Upgrade auf StorageGRID 12.0
...
+
Sie sollten bis zu 17 Stunden einplanen, um das Upgrade Ihres Systems auf StorageGRID 12.0.0 abzuschließen.
