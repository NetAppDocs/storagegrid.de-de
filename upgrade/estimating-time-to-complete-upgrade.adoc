...
== Beispiel: Geschätzte Zeit für das Upgrade auf StorageGRID 12.1
...
+
Für das Upgrade Ihres Systems auf StorageGRID 12.1.0 sollte bis zu 18 Stunden eingeplant werden.
