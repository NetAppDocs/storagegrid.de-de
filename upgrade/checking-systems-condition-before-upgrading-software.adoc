...
---
= Überprüfen Sie den Zustand Ihres StorageGRID-Systems vor dem Upgrade
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Siehe link:../network/internal-grid-node-communications.html["Interne Kommunikation mit Grid-Nodes"] und link:../network/external-communications.html["Externe Kommunikation"], um sicherzustellen, dass alle für StorageGRID 12.1 erforderlichen Ports vor dem Upgrade geöffnet sind.
+

NOTE: Für das Upgrade auf StorageGRID 12.1 werden keine zusätzlichen Ports benötigt.
