...
summary: Sie können auf StorageGRID 12.1 aktualisieren und gleichzeitig den neuesten Hotfix für diese Version anwenden. Die StorageGRID Upgrade-Seite bietet den empfohlenen Upgrade-Pfad und Links direkt zu den richtigen Download-Seiten. 
---
= Führen Sie ein StorageGRID Upgrade durch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können auf StorageGRID 12.1 aktualisieren und gleichzeitig den neuesten Hotfix für diese Version anwenden. Die StorageGRID Upgrade-Seite bietet den empfohlenen Upgrade-Pfad und Links direkt zu den richtigen Download-Seiten.
...
Der Aktualisierungspfad auf der StorageGRID Upgrade-Seite zeigt an, welche Hauptversionen (z. B. 12.1.0) und Hotfixes (z. B. 12.1.0.1) installiert werden müssen, um die neueste StorageGRID Version zu erhalten. Die empfohlenen Versionen und Hotfixes sollten in der angegebenen Reihenfolge installiert werden.
...
. Wählen Sie *Durchsuchen*, um die Versionsaktualisierungsdatei in StorageGRID hochzuladen: `NetApp_StorageGRID_12.1.0_Software_uniqueID.upgrade`
+
...
. Die Details jedes gemeldeten Vorabchecks sollten überprüft und alle gemeldeten Fehler behoben werden. Siehe die  https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_12.1_software_upgrade_resolution_guide["Lösungsleitfaden für StorageGRID Software-Upgrades"^] zur StorageGRID 12.1 Version.
+
...
NOTE: Für ein StorageGRID 12.1 Upgrade empfiehlt es sich, wenn einzelne Knoten anstelle aller Knoten genehmigt werden sollen, zunächst einen gesamten Standort zu aktualisieren, bevor mit dem nächsten Standort fortgefahren wird.
...
.Schritte
. Sobald die Aufgabe *Funktionen aktivieren* abgeschlossen ist (bis zu einer Stunde), kann die link:whats-new.html["Neuer Funktionen"] in der aktualisierten StorageGRID Version verwendet werden.
+
