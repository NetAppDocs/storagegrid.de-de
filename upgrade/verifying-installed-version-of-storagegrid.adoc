...
---
= Überprüfen Sie die installierte Version von StorageGRID, bevor Sie ein Upgrade durchführen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
Bevor Sie auf StorageGRID 12.1 aktualisieren, muss in Ihrem Grid StorageGRID 12.0 oder höher installiert sein. Wenn Sie derzeit eine frühere Version von StorageGRID verwenden, müssen alle vorherigen Upgrade-Dateien zusammen mit den jeweils neuesten Hotfixes (dringend empfohlen) installiert werden, bis die aktuelle Version Ihres Grids mindestens StorageGRID 12.0.0 ist.
...
Das folgende Beispiel zeigt die Schritte für ein Upgrade von StorageGRID Version 11.9 auf Version 12.0 in Vorbereitung auf ein Upgrade auf StorageGRID 12.1.
