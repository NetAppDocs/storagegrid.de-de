...
summary: StorageGRID 12.0 erweitert die Objektspeicherkapazität, verbessert die Unterstützung von KI/ML-Workloads, stärkt die Grid-Federation, vereinfacht Systemmanagement und erhöht die Sicherheit auf der gesamten Plattform. 
---
...
[role="lead"]
StorageGRID 12.0 erweitert die Objektspeicherkapazität, verbessert die Unterstützung von KI/ML-Workloads, stärkt die Grid-Federation, vereinfacht Systemmanagement und erhöht die Sicherheit auf der gesamten Plattform.

Einzelheiten zu behobenen und bekannten Problemen in den aktuellen StorageGRID 12.0-Versionen finden Sie in den  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["StorageGRID 12.0 Versionshinweise"^]. Sie müssen sich mit Ihrem NetApp Account anmelden oder ein Konto erstellen, um auf die Release notes zuzugreifen.
