...
sidebar: sidebar 
keywords:  
summary: Informieren Sie sich über die in StorageGRID 12.0 entfernten oder als veraltet markierten Funktionen und Möglichkeiten. Prüfen Sie vor dem Upgrade, ob entfernte oder veraltete Funktionen Ihre Clientanwendungen oder die Grid-Konfiguration beeinträchtigen. 
---
...
[role="lead"]
Informieren Sie sich über die in StorageGRID 12.0 entfernten oder als veraltet markierten Funktionen und Möglichkeiten. Prüfen Sie vor dem Upgrade, ob entfernte oder veraltete Funktionen Ihre Clientanwendungen oder die Grid-Konfiguration beeinträchtigen.
