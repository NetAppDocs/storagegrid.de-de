...
summary: StorageGRID 12.0 verwendet Version 4 der Grid Management API. Version 4 setzt Version 3 außer Kraft. Versionen 1, 2 und 3 werden jedoch weiterhin unterstützt. 
---
