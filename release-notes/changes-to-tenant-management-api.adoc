...
summary: StorageGRID 12.0 verwendet Version 4 der Tenant Management API. Version 4 ersetzt Version 3. Die Versionen 1, 2 und 3 werden jedoch weiterhin unterstützt. 
---
