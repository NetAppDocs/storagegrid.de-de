...
---
= Wiederherstellung des primären oder nicht-primären Admin-Node in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Wahlmöglichkeiten
* link:recovering-from-primary-admin-node-failures.html["Den primären Admin-Node mit demselben primären Admin-Node wiederherstellen"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["Wiederherstellung nach Ausfällen des primären Admin-Knotens mithilfe eines nicht-primären Admin-Knotens"]
