...
---
= StorageGRID Audit-Protokolle von einem ausgefallenen primären Admin-Knoten kopieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Geben Sie den folgenden Befehl ein, um zum Root-Benutzerkonto zu wechseln: `su -`
.. Geben Sie das in der Datei aufgeführte Passwort ein `Passwords.txt`.
+
...
+
Wenn Sie dazu aufgefordert werden, das Passwort für das Admin-Benutzerkonto eingeben.
...
. Als Root-Benutzer abmelden: `exit`.
