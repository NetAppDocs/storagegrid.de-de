...
+
image:recovery_reset_button.gif["Screenshot mit der Bühne, die auf manuelle Schritte wartet"]
...
+
image:recovery_reset_warning.gif["Screenshot mit dem Dialogfeld Warnung zum Zurücksetzen der Wiederherstellung"]
