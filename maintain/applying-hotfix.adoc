...
---
= Einen Hotfix in StorageGRID anwenden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:software_update_landing.png["Landing Page Für Software-Updates"]
...
+
image:hotfix_choose_file.png["Hotfix Wählen Sie Datei"]
...
+
image:hotfix_progress_table.png["Hotfix-Fortschrittstabelle"]
...
+
image:approve_all_progresstable.png["Hotfix-Fortschritt mit Entnahme-Taste"]
