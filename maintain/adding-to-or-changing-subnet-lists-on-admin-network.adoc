...
---
= Subnetzlisten im Admin-Netzwerk in StorageGRID hinzufügen oder ändern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_aesl_sample_input.gif["Beispiel für das ip-Tool ändern"]
...
+
image:change_ip_tool_aesl_sample_output.png["Screenshot, der durch umgebenden Text beschrieben wird"]
