...
---
= Führen Sie einen rollierenden Neustart von StorageGRID durch.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
TIP: Ein Knoten kann nicht neu gestartet werden, wenn er vom Grid getrennt ist. Die Kontrollkästchen sind für Knoten mit diesen Symbolen deaktiviert: image:icon_alarm_gray_administratively_down.png["Graues Fragezeichen-Symbol"] oder image:icon_alarm_blue_unknown.png["Blaues Fragezeichen-Symbol"].
