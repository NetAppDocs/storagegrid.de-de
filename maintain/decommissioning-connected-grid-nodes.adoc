...
---
= Angeschlossene StorageGRID-Knoten außer Betrieb nehmen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Alle Grid-Knoten haben einen normalen (grünen) Zustand image:icon_alert_green_checkmark.png["Grünes Häkchen"]. Wenn eines dieser Symbole in der Spalte *Zustand* angezeigt wird, sollte das Problem behoben werden:
+
[cols="1a,1a,3a"]
|===
| Symbol | Farbe | Schweregrad 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["Gelbes Quadrat-Symbol"]
 a| 
Gelb
 a| 
Hinweis
 ...
 a| 
image:icon_alert_yellow_minor.png["Hellorangefarbenes Diamantsymbol"]
 a| 
Hellorange
 a| 
Gering
 ...
 a| 
image:icon_alert_orange_major.png["Dunkles orangefarbenes Diamantsymbol"]
 a| 
Dunkelorange
 a| 
Major
 ...
 a| 
image:icon_alert_red_critical.png["Rotes X-Symbol"]
 a| 
Rot
 a| 
Kritisch
