...
---
= Subnetzlisten im Grid-Netzwerk in StorageGRID hinzufügen oder ändern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_gnsl_sample_input.gif["Screenshot, der durch umgebenden Text beschrieben wird"]
...
+
image:change_ip_tool_gnsl_sample_output.gif["Screenshot, der durch umgebenden Text beschrieben wird"]
