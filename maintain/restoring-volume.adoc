...
---
= Objektdaten mithilfe von StorageGRID Grid Manager wiederherstellen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Sie haben bestätigt, dass der Storage Node, auf dem Sie Objekte wiederherstellen, im Grid Manager auf der Registerkarte *Nodes* > *Overview* den Connection State *Connected* image:icon_alert_green_checkmark.png["Symbol Warnung grünes Häkchen"] aufweist.
