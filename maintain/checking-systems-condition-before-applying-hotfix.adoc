...
---
= Prüfen Sie den Systemzustand, bevor Sie einen StorageGRID Hotfix anwenden.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Verbundene Knoten haben grüne Häkchen image:icon_alert_green_checkmark.png["Symbol Warnung grünes Häkchen"] auf der Seite „Knoten“.
