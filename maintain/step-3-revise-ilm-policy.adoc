...
summary: 'In Schritt 3 (ILM-Richtlinien überarbeiten) des Assistenten zum Entnehmen von Websites können Sie bestimmen, ob der Standort durch eine ILM-Richtlinie referenziert wird.' 
---
= Überarbeiten Sie die ILM-Richtlinien für die Standortstilllegung in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
