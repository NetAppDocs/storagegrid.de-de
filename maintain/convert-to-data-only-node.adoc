...
---
= Konvertieren eines StorageGRID-Speicherknotens in einen reinen Datenknoten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Wenn der Speicherknoten den ADC-Dienst enthält, mehr als zwei ADC-Speicherknoten im gesamten Grid online sind und Nicht-ADC-Speicherknoten am selben Standort zur Verfügung stehen, um den ADC-Dienst zu hosten.
...
.Über diese Aufgabe
Dieses Verfahren dient dazu, einen oder mehrere kombinierte Storage Nodes in reine Datenknoten umzuwandeln. Wenn ein Storage Node den ADC-Service enthält, wird der Service während der Umwandlung automatisch auf einen anderen Storage Node am selben Standort verschoben.
...
NOTE: StorageGRID verschiebt den ADC-Dienst auf die neuesten Storage Nodes, die die Anforderungen für das Hosting des Dienstes erfüllen.
