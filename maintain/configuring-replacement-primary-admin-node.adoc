...
* Sie haben die letzte Sicherung der Wiederherstellungspaketdatei (`sgws-recovery-package-_id-revision_.zip`).
...
. Laden Sie das letzte Backup des Wiederherstellungspakets hoch:
+
.. Klicken Sie Auf *Durchsuchen*.
.. Suchen Sie die neueste Wiederherstellungspaket-Datei für Ihr StorageGRID-System, und klicken Sie auf *Öffnen*.
