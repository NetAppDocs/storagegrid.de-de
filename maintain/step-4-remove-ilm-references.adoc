...
summary: 'Aus Schritt 4 (ILM-Verweise entfernen) des Assistenten zum Entnehmen von Standorten müssen Sie alle nicht verwendeten ILM-Regeln löschen oder bearbeiten, die sich auf den Standort beziehen, selbst wenn die Regeln in keiner ILM-Richtlinie verwendet werden.' 
---
= Entfernen von ILM-Referenzen zu einem Standort in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Um eine Regel zu löschen, das Papierkorbsymbol image:icon_trash_can.png["Symbol Papierkorb Kann"] auswählen und *OK* wählen.
+
