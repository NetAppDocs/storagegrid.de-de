...
CAUTION: Wenden Sie sich an den technischen Support, wenn mehr als ein Storage Node offline ist. Führen Sie das Skript nicht aus `sn-recovery-postinstall.sh`.
