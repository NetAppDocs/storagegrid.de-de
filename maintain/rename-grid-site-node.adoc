...
. Um Elemente zu entfernen, die Sie nicht umbenennen möchten, wählen Sie image:icon_x_to_remove.png["X-Symbol"] in der Spalte *Aus Liste entfernen* aus.
+
...
. Wählen Sie image:icon_x_to_remove.png["X-Symbol"] aus, um alle Elemente zu entfernen, die Sie mit diesem Tool nicht umbenennen möchten.
+
Angenommen, Sie möchten beispielsweise alle Knoten umbenennen, die die Zeichenfolge  `Data-Center-1` enthalten, aber die  `Data-Center-1` Site selbst nicht umbenennen. Wählen Sie image:icon_x_to_remove.png["X-Symbol"] aus, um die Site aus der Umbenennungsvorschau zu entfernen.

+
image:rename_bulk_rename_tool.png["Tool zum Umbenennen mehrerer Dateien vorher"]
...
+
image:rename_bulk_rename_tool_after.png["Tool zum Umbenennen von Massen nach"]
...
. Nehmen Sie alle erforderlichen zusätzlichen Änderungen vor oder wählen Sie image:icon_x_to_remove.png["X-Symbol"] aus, um alle Elemente zu entfernen, die Sie nicht umbenennen möchten.
...
--
.. Kopieren Sie den ursprünglichen Systemnamen jedes Elements und fügen Sie ihn in das Feld *Anzeigename* ein, oder wählen Sie image:icon_x_to_remove.png["X-Symbol"] aus, um Elemente zu entfernen, die Sie nicht wiederherstellen möchten.
+
...
.. Bestätigen Sie, dass jeder Eintrag im Feld *Anzeigename* mit dem Namen im Feld *Systemname* übereinstimmt. Nehmen Sie gegebenenfalls Änderungen vor oder wählen Sie image:icon_x_to_remove.png["X-Symbol"] aus, um Elemente zu entfernen, die Sie nicht zurücksetzen möchten.
+
Um einen Anzeigenamen rückgängig zu machen, muss der Systemname im Feld *Anzeigename* angezeigt werden, der Name muss jedoch nicht zwischen Groß- und Kleinschreibung unterschieden werden.
