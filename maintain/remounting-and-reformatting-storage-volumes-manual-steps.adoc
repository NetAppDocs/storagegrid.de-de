...
+
** In den meisten Fällen sollte link:../maintain/restoring-object-data-to-storage-volume.html["Stellen Sie Objektdaten mithilfe von Grid Manager wieder her"] verwendet werden. Antwort `y` zur Verwendung des Grid Manager.
