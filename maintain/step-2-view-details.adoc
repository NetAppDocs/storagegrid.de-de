...
---
= Überprüfen Sie die Standortdetails vor der Stilllegung in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_2_site_warnings.png["Deaktivieren Sie Die Warnungen Zu Standortschritt 2"]
...
** Die Website enthält eine Mischung aus verbundenen (image:icon_alert_green_checkmark.png["Symbol Warnung Grün Häkchen"]) und getrennten Knoten (image:icon_alarm_gray_administratively_down.png["Icon Alarm Grau Administrativ Nach Unten"] oder image:icon_alarm_blue_unknown.png["Symbolalarm Blau Unbekannt"]). Vor dem Entfernen dieser Website müssen alle Offline-Knoten wieder online sein.


. Überprüfen Sie die Details der zu entfernenden Site.
+
image:decommission_site_step_2_view_details.png["Deaktivieren Sie Die Option Site Schritt 2 Anzeigen Details"]
...
+
*** image:icon_alert_green_checkmark.png["Symbol Warnung Grün Häkchen"] (Verbunden)
*** image:icon_alarm_gray_administratively_down.png["Icon Alarm Grau Administrativ Nach Unten"] (Administrativ eingestellt)
*** image:icon_alarm_blue_unknown.png["Symbolalarm Blau Unbekannt"] (Unbekannt)
...
+
image:decommission_site_step_2_view_details_for_other_sites.png["Deaktivieren Sie Site Schritt 2 Anzeigen Details für andere Standorte"]
