...
---
= Stilllegungsprozess für StorageGRID Storage Nodes anhalten und fortsetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_nodes_procedure_paused.png["Verfahren Für Die Deaktivierung Von Knoten Angehalten"]
