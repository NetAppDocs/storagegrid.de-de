...
---
= Beheben Sie Knotenkonflikte und starten Sie die Standortstilllegung in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Alle Knoten in Ihrem StorageGRID System müssen verbunden sein (image:icon_alert_green_checkmark.png["Symbol Warnung Grün Häkchen"]).
+
...
.Schritte
. Im Abschnitt „Getrennte Knoten“ von Schritt 5 (Knotenkonflikte lösen) kann festgestellt werden, ob Knoten in Ihrem StorageGRID System den Verbindungsstatus Unbekannt (image:icon_alarm_blue_unknown.png["Symbolalarm Blau Unbekannt"]) oder Administrativ deaktiviert (image:icon_alarm_gray_administratively_down.png["Icon Alarm Grau Administrativ Nach Unten"]) aufweisen.
+
image:decommission_site_step_5_disconnected_nodes.png["Deaktivieren Sie Site Schritt 5 Auflösen Von Knotenkonflikten"]
...
+
image:decommission_site_step_5_ha_groups.png["Mustern Sie Schritt 5 HA-Gruppen auf"]
...
+
Wenn alle Knoten verbunden sind und keine Knoten im ausgewählten Standort in einer HA-Gruppe verwendet werden, ist das Feld *Provisioning passphrase* aktiviert.
...
+
image:decommission_site_step_5_provision_passphrase.png["Legen Sie Die Bereitstellpassphrase Für Standortschritt 5 Außer Betrieb"]
...
+
image:decommission_site_step_5_warning.png["Warnung Für Site-Schritt 5 Ausmustern"]
...
+
image:decommission_site_step_5_grid_configuration.png["Deaktivieren Sie Die Grid-Konfiguration Für Site Schritt 5"]
