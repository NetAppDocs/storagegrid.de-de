...
summary: Das Revisionsprotokoll auf dem wiederhergestellten primären Admin-Node wird mithilfe eines nicht-primären Admin-Nodes wiederhergestellt. 
---
= Das StorageGRID Revisionsprotokoll auf einem wiederhergestellten primären Admin-Knoten wiederherstellen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
