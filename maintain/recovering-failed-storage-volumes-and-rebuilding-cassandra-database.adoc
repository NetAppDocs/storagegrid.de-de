...
Nachdem die Speichervolumes neu formatiert und wieder eingebunden wurden und die notwendigen Cassandra-Operationen abgeschlossen sind, können Sie link:../maintain/restoring-object-data-to-storage-volume-where-system-drive-is-intact.html["Stellen Sie Objektdaten mithilfe von Grid Manager wieder her"].
