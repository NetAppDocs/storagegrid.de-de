...
---
= Führen Sie zusätzliche Schritte zur Wiederherstellung des StorageGRID-Knotens durch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html["Wiederherstellung des primären Admin-Knotens mithilfe eines nicht-primären Admin-Knotens"]
