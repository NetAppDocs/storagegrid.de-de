...
---
= Installation der StorageGRID-Services-Appliance überwachen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Schritte
. Der Installationsfortschritt lässt sich in der Menüleiste über *Installation überwachen* einsehen.
+
