...
summary: Widersprüchliche Clientanfragen, wie zum Beispiel das gleichzeitige Schreiben zweier Clients auf denselben Schlüssel, werden nach dem Prinzip „Latest-wins“ gelöst. 
---
