...
summary: Die PUT Bucket Last Access Time-Anfrage ermöglicht es Ihnen, die Aktualisierung des letzten Zugriffszeitpunkts für einzelne Buckets zu aktivieren oder zu deaktivieren. 
---
