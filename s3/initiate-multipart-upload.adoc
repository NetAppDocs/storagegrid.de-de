...
NOTE: Wenn die CreateMultipartUpload-Anfrage keine Prüfsumme angibt, berechnet StorageGRID keine Standard-CRC-64/NVME-Prüfsumme für ein Objekt. StorageGRID ignoriert ungültige oder nicht unterstützte  `x-amz-checksum-algorithm` Werte.
