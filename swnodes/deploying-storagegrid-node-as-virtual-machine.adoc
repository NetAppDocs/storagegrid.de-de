...
+
Möglicherweise ist eine Neuzuordnung eines Ports erforderlich, wenn die Netzwerkrichtlinien Ihres Unternehmens den Zugriff auf einen oder mehrere von StorageGRID verwendete Ports einschränken. Siehe link:../network/index.html["Netzwerkrichtlinien"] für die von StorageGRID verwendeten Ports.
