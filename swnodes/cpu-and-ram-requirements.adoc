...
** Wenn mehrere Mandanten jeweils bis zu 5.000 Buckets haben, mindestens 64 GB pro Knoten
+

NOTE: Das StorageGRID System unterstützt maximal 20.000 Buckets für jedes S3-Mandantenkonto.
...
CAUTION: Die CPU- und Speicherauslastung sollte regelmäßig überwacht werden, damit diese Ressourcen weiterhin für die jeweilige Arbeitslast ausreichen. Beispielsweise würde eine Verdopplung der RAM- und CPU-Zuweisung für virtuelle Storage Nodes ähnliche Ressourcen wie für StorageGRID Appliance Nodes bereitstellen. Überschreitet die Metadatenmenge pro Knoten 500 GB, empfiehlt sich eine Erhöhung des RAM pro Knoten auf 48 GB oder mehr. Informationen zur Verwaltung des Objekt-Metadatenspeichers, zur Erhöhung der Einstellung Metadata Reserved Space sowie zur Überwachung der CPU- und Speicherauslastung finden sich in den Anleitungen für link:../admin/index.html["Administration"]link:../monitor/index.html["Monitoring"]link:../upgrade/index.html["Aktualisierung"] StorageGRID.
...
Weitere Informationen finden Sie unter link:storage-and-performance-requirements.html["Storage- und Performance-Anforderungen erfüllt"].
