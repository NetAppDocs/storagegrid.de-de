...
----
* AppArmor vollständig deaktivieren. Für Ubuntu 9.10 oder höher sind die Anweisungen in  https://help.ubuntu.com/community["Ubuntu Online Community"] zu befolgen. Das vollständige Deaktivieren von AppArmor ist auf neueren Ubuntu-Versionen möglicherweise nicht möglich.
+
