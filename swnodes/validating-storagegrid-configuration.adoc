...
image:rhel_node_configuration_file_output.gif["Dieses Bild wird durch den umgebenden Text erläutert."]
...
image:rhel_node_configuration_file_output_with_errors.gif["Dieses Bild wird durch den umgebenden Text erläutert."]
