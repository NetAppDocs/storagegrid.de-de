...
summary: Sie können das VMware OVF Tool verwenden, um die Bereitstellung von Grid-Knoten in StorageGRID zu automatisieren. Sie können auch die Konfiguration von StorageGRID automatisieren. 
---
