...
.Bevor Sie beginnen
Sie haben link:../vmware/downloading-and-extracting-storagegrid-installation-files.html#vmware-download-verification-package["Verifikationspaket heruntergeladen"] von der https://mysupport.netapp.com/site/products/all/details/storagegrid/downloads-tab["NetApp Download-Seite für StorageGRID"^].
...
. link:../vmware/downloading-and-extracting-storagegrid-installation-files.html["Führen Sie die verbleibenden Schritte aus"] Um die entsprechenden Installationsdateien zu extrahieren und auszuwählen.
