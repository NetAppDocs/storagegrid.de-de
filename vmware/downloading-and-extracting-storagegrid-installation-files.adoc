...
. Wählen Sie in der Spalte *Install StorageGRID* das Installationsarchiv .tgz oder .zip für VMware aus.
+
...
.. Befolgen Sie die Schritte bis link:../vmware/download-files-verify.html["Überprüfen Sie die Installationsdateien manuell"].
