...
image:grid_manager_dashboard_and_menu.png["Dashboard im Grid Manager"]

Eine Erklärung der auf den einzelnen Karten angezeigten Informationen findet sich durch Auswahl des Hilfesymbols image:icon_nms_question.png["Fragezeichen-Symbol"] für die jeweilige Karte.
...
Das Hilfemenü image:icon_help_menu_bar.png["Hilfe-Symbol in der Menüleiste"] bietet Zugriff auf:
...
* E-Mail-Benachrichtigungen für StorageGRID Warnungen konfigurieren
...
* Verwenden Sie link:../admin/grid-federation-overview.html["Grid-Verbund"], um Mandantenkontoinformationen zu synchronisieren und Objektdaten zwischen zwei StorageGRID Systemen zu replizieren.
...
* link:../monitor/configure-email-server.html["E-Mail-Server konfigurieren"]
...
* link:../admin/about-multi-admin-verify.html["Multi-Admin-Verifizierung konfigurieren"]
...
* Wiederherstellen der Objektdaten
+
...
* link:../monitor/configure-autosupport-grid-manager.html["Konfigurieren Sie AutoSupport"]
