...
image:replication_data_flow.png["Diagramm mit dem im umgebenden Text beschriebenen Prozess"]
...
image:erasure_coding_data_flow.png["Verfahren Zur Einhaltung Von Datenkonsistenz"]
...
image:cloud_storage_pool_data_flow.png["Datenfluss In Den Cloud-Storage-Pool"]
