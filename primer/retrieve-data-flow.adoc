...
image:retrieve_data_flow.png["Abrufen"]
...
. Der Quell-LDR-Dienst gibt die abgerufenen Objektdaten an den abgefragten LDR-Dienst zurück, und das System gibt das Objekt an die Clientanwendung zurück.
