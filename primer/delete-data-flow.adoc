...
Siehe link:../ilm/how-objects-and-delete-markers-are-deleted.html["Wie Objekte und Löschmarkierungen gelöscht werden"] für weitere Informationen.
...
image:delete_data_flow.png["Client löscht den Datenfluss"]
...
image:automatic_deletion_data_flow.png["Automatisches Löschen des Datenflusses"]
