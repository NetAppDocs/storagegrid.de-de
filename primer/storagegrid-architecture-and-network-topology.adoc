...
Weitere Informationen zur StorageGRID Netzwerktopologie, zu den Anforderungen und zur Grid-Kommunikation sind unter link:../network/index.html["Netzwerkrichtlinien"] zu finden.
...
image:data_center_site_single.png["Einzelner Datacenter-Standort"]
...
image:data_center_sites_multiple.png["Mehrere Datacenter-Standorte"]
...
image:grid_nodes_and_components.png["Diagramm mit umgebenden Text beschrieben"]
