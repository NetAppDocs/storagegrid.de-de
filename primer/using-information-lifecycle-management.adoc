...
summary: 'Mit Information Lifecycle Management (ILM) wird die Platzierung, die Speicherdauer und das Aufnahmeverhalten aller Objekte im StorageGRID System gesteuert. ILM-Regeln bestimmen, wie StorageGRID Objekte im Zeitverlauf speichert. Eine oder mehrere ILM-Regeln werden konfiguriert und anschließend einer ILM-Richtlinie hinzugefügt.' 
---
