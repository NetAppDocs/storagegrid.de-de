...
image:object_conceptual_drawing.png["Objekt"]
...
image:ilm_replication_make_2_copies.png["Regel für 2 Kopien erstellen"]
...
image:ec_three_sites_4_plus_2.png["Löschvorgang Codiert Drei Standorte 4 Plus 2"]
