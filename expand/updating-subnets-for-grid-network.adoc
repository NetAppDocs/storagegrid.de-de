...
---
= Fügen Sie dem Grid-Netzwerk in StorageGRID Subnetze hinzu oder aktualisieren Sie diese, um die Erweiterung zu ermöglichen.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Für das Grid Network, das Admin Network oder das Client Network eines beliebigen Node sollten keine Subnetze verwendet werden, die die folgenden IPv4-Adressen enthalten:
