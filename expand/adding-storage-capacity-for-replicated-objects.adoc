...
summary: 'Wenn die Information Lifecycle Management-Richtlinie (ILM) für Ihre Implementierung eine Regel umfasst, die replizierte Kopien von Objekten erstellt, müssen Sie berücksichtigen, wie viel Storage hinzugefügt werden muss und wo die neuen Storage Volumes oder Storage-Nodes hinzugefügt werden müssen.' 
---
= Erweiterungsplanung für replizierte Daten in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
