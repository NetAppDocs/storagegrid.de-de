...
---
= Bereiten Sie sich auf die Erweiterung Ihres StorageGRID Systems vor.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Versionshinweise"^]. Sie müssen sich mit Ihrem NetApp-Konto anmelden oder ein Konto erstellen, um auf die Versionshinweise zugreifen zu können.
* link:../swnodes/index.html["Installationsanweisungen für Ihre Plattform"]
...
. Wenn Sie ein RHEL-System erweitern, wählen Sie die entsprechenden Dateien aus.
