...
---
= Richtlinien zum Hinzufügen von Metadatenkapazität in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:metadata_space_after_expansion.png["Diagramm der neu verteilten Metadaten nach dem Hinzufügen von zwei Storage-Nodes"]
