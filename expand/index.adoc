...
---
= Erfahren Sie mehr über die Erweiterung Ihres StorageGRID Systems.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Erfahren Sie, wie Sie Ihr StorageGRID System erweitern können, um die Kapazität oder die Funktionen zu erhöhen, ohne den Betrieb zu unterbrechen. Sie können Speichervolumes zu bestehenden Speicherknoten hinzufügen, neue Grid-Knoten zu einem bestehenden Standort hinzufügen oder einen neuen Standort hinzufügen.
