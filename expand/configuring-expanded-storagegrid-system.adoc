...
---
= Konfigurieren Sie neu hinzugefügte Knoten und Standorte in StorageGRID.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Wenn Single Sign-On (SSO) für Ihr StorageGRID System aktiviert ist, muss eine Relying-Party-Vertrauensstellung für den neuen Admin Node erstellt werden. Eine Anmeldung am Node ist erst möglich, nachdem diese Relying-Party-Vertrauensstellung erstellt wurde. Weitere Informationen zur Einrichtung von SSO finden sich unter link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] oder link:../admin/learn-about-setting-up-sso-saml.html["SAML"].
