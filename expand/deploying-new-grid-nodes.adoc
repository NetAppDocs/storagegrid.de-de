...
---
= Neue Grid-Knoten in StorageGRID bereitstellen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Falls Sie die Seite zur Monitor Installation manuell aufrufen müssen, in der Menüleiste *Monitor Installation* auswählen.
+
Auf der Installationsseite des Monitors wird der Installationsfortschritt angezeigt.
