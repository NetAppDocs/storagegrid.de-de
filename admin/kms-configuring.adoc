...
summary: 'Ein Key Management Server (KMS) ist ein externes System eines Drittanbieters, das Verschlüsselungsschlüssel für StorageGRID Appliance-Knoten am zugehörigen StorageGRID Standort unter Verwendung des Key Management Interoperability Protocol (KMIP) bereitstellt.' 
---
