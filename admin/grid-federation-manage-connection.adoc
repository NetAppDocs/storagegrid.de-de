...
NOTE: Während die Verbindung bearbeitet wird, werden Kontosynchronisierungs- oder netzübergreifende Replikationsanfragen weiterhin mit den bestehenden Verbindungseinstellungen ausgeführt. Es kann jeweils nur eine Verbindung bearbeitet und für jede Verbindung eine Bestätigungsdatei in das Remote-Grid hochgeladen werden. Änderungen werden nach dem Hochladen in die Remote-Grids übernommen.
...
image:grid_federation_remove_connection.png["Schritte zum Entfernen der Netzverbundverbindung"]
