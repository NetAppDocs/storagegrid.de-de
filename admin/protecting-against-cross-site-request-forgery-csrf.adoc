...
summary: 'Gegen Cross-Site Request Forgery (CSRF)-Angriffe auf StorageGRID kann durch die Verwendung von CSRF-Token zum Schutz der Authentifizierung, die Cookies verwendet, vorgebeugt werden.' 
---
