...
+
image:sign_out.png["Link „Abmelden“"]
...
*Hinweis:* Wenn SSO aktiviert ist und Sie auch beim Tenant Manager angemeldet sind, müssen Sie auchlink:../tenant/signing-out-of-tenant-manager.html["melden Sie sich vom Mieterkonto ab"] Zulink:how-sso-works.html["von SSO abmelden"] .
