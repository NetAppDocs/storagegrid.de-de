...
image:dashboard_health_panel_license_status.png["Status Der Dashboard-Statuskarte Lizenzstatus"]
...
+
Dieses Datum wird aus der aktuellen Lizenzdatei gelesen und kann veraltet sein, wenn der Supportvertrag nach Erhalt der Lizenzdatei verlängert oder erneuert wurde. Zum Aktualisieren dieses Werts siehe link:updating-storagegrid-license-information.html["Aktualisieren Sie die StorageGRID-Lizenzinformationen"]. Das tatsächliche Vertragsende lässt sich auch mit Digital Advisor anzeigen.
