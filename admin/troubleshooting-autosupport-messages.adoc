...
summary: Wenn ein Versuch, ein AutoSupport-Paket zu senden, fehlschlägt, ergreift das StorageGRID-System je nach Typ des AutoSupport-Pakets unterschiedliche Maßnahmen. 
---
