...
+
--
Wenn Sie S3-Anfragen im Virtual-Hosted-Style verwenden möchten, sollten Sie link:../admin/configuring-s3-api-endpoint-domain-names.html["Domänennamen des S3-Endpunkts wurden konfiguriert"] haben. Die Verwendung von Virtual-Hosted-Style-Anfragen wird empfohlen.
...
--
Konfigurieren Sie alle Verbindungen des Grid-Verbunds:: Wenn Sie dem S3-Mandanten erlauben möchten, Kontodaten zu synchronisieren und Bucket-Objekte mithilfe einer Grid Federation-Verbindung in ein anderes Grid zu replizieren, sollte Folgendes vor dem Start des Assistenten bestätigt werden:
+
--
