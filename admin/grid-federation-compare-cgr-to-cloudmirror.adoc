...
. Neue Mandantenkonten hinzufügen, die automatisch mit dem anderen Grid synchronisiert werden.
. Neue Mandantengruppen und Benutzer werden hinzugefügt und ebenfalls synchronisiert.
