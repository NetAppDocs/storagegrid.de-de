...
summary: 'Hochverfügbarkeitsgruppen (HA-Gruppen) bieten hochverfügbare Datenverbindungen für S3-Clients und hochverfügbare Verbindungen zu Grid Manager und Tenant Manager.' 
---
...
image:ha_group_primary_interface.png["Primäre Schnittstelle DER HA-Gruppe"]
