...
.Schritte
. Im Header des Grid Manager das Hilfesymbol image:icon_help_menu_bar.png["Hilfesymbol"] auswählen und *API documentation* wählen.
...
+
image:swagger_example.png["Beispiel aus Swagger UI"]
