...
* Sie haben die *SP-Verbindungs-ID* für jeden Admin-Knoten in Ihrem System. Diese Werte finden Sie in der Detailtabelle Admin-Nodes auf der Seite SSO konfigurieren.
...
* Sie haben den link:../admin/admin-group-permissions.html["Administratorberechtigung"] für PingFederate Server.
...
. Wählen Sie die SAML-Metadatendatei aus, die Sie von der Seite SSO konfigurieren für den Admin-Node heruntergeladen haben.
