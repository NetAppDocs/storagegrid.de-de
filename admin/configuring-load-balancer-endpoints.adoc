...
Wenn Sie Load-Balancer-Endpunkte für einen link:../admin/configure-global-namespace.html["globaler Namensraum"] konfigurieren, sollte für jeden Endpunkt derselbe Port verwendet werden.
...
+
image:load_balancer_endpoint_details.png["Details zum Endpunkt der Load Balancer"]
...
.. Das Bearbeitungssymbol image:icon_edit_tm.png["Symbol bearbeiten"] auswählen.
.. Geben Sie den neuen Namen ein.
.. Wählen Sie *Speichern*.
