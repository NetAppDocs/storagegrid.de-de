...
summary: 'Sie können Hochverfügbarkeitsgruppen (High Availability groups, HA-Gruppen) konfigurieren, um hochverfügbaren Zugriff auf die Services in Admin-Nodes oder Gateway-Nodes bereitzustellen.' 
---
...
+
image:ha_group_add_interfaces.png["HA Groups Add Interfaces"]
...
+
image:vlan_parent_interface_tooltip.png["Tipp des VLAN Interface-Tools"]
...
+
image:ha_group_determine_failover.png["HA-Gruppen bestimmen die Prioritätsreihenfolge"]
...
+
image:ha_group_select_virtual_ips.png["HA-Gruppen geben VIPs ein"]
