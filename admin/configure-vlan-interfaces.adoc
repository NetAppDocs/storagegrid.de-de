...
+
image:vlan_create_parent_interfaces.png["Übergeordnete Schnittstellen des Assistenten zur Erstellung von VLANs"]
...
** Wenn Sie eine übergeordnete Schnittstelle entfernen müssen, wählen Sie den Papierkorb image:icon_trash_can.png["Papierkorb-Symbol"] aus.
