...
+
image:grid-federation-tenant-detail.png["Registerkarte „Grid Federation“ auf der Seite „Tenant Details“"]
...
image:grid-federation-remove-permission.png["Schritte zum Entfernen der Netzverbundverbindung"]
...
+
image:grid-federation-remove-permission-error.png["Es wird eine Fehlermeldung angezeigt, wenn der Mandant cgr für einen Bucket aktiviert hat"]
