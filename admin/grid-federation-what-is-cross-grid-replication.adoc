...
image:grid-federation-cross-grid-replication-one-direction.png["Abbildung zeigt die Verbindung mit dem Grid Federation in eine Richtung"]
...
image:grid-federation-cross-grid-replication.png["Bild zeigt Replikation in eine Richtung im Vergleich zur Replikation in beide Richtungen"]
...
image:grid-federation-cross-grid-replication-delete.png["Abbildung zeigt, wie der Replikate-Client auf beiden Rastern gelöscht wird"]
