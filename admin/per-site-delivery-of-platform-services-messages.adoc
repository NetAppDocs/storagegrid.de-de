...
image:notification_multiple_sites.gif["Das Diagramm zeigt, dass die Aktion auf Objekt an Standort 1 eine Benachrichtigung von Standort 1 auslöst"]
...
image:notifications_site_2.gif["Das Diagramm zeigt die Aktion für das Objekt von Standort 2 löst Benachrichtigungen von Standort 2 aus"]
