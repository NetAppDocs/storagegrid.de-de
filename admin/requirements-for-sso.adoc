...
StorageGRID unterstützt mehrere SSO Identitätsanbieter (IdP).

[role="tabbed-block"]
====
.OIDC
--
Die folgenden SSO IdPs werden für OpenID Connect (OIDC) unterstützt:
...
.SAML
--
Die folgenden SSO IdPs werden für Security Assertion Markup Language 2.0 (SAML 2.0) unterstützt:
