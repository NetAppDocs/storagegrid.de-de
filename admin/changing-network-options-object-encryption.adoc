...
NOTE: Ab StorageGRID 12.1.0 ist die Unterstützung für die AES-128-Verschlüsselung neu gespeicherter Objektdaten im Ruhezustand veraltet. Die Unterstützung für das Abrufen gespeicherter Objekte, die ursprünglich mit AES-128 verschlüsselt wurden, bleibt bestehen.
