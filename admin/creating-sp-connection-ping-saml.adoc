...
---
= Dienstanbieterverbindungen in PingFederate für SAML in StorageGRID erstellen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mit PingFederate wird für jeden Admin Node in Ihrem System eine Service Provider (SP) Verbindung für SAML erstellt. Zur Beschleunigung des Prozesses werden die SAML-Metadaten aus StorageGRID importiert.
