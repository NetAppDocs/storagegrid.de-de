...
image:grid-federation-workflow.png["Workflow der Grid-Föderation-Verbindung"]
...
+
Einzelheiten zu den Versionsvoraussetzungen finden Sie in der  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Versionshinweise"^]. Sie müssen sich mit Ihrem NetApp Konto anmelden oder ein Konto erstellen, um auf die Release Notes zuzugreifen.
...
image:grid-federation-certificates.png["Zertifikate für Grid Federation"]
