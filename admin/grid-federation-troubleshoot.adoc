...
* Das Quellobjekt verfügt über S3 Object Lock-Einstellungen, die nicht den Aufbewahrungseinstellungen des Zielrasters auf Mandantenebene entsprechen.
* Das Quellobjekt verfügt über S3 Object Lock-Einstellungen, und S3 Object Lock ist auf dem Ziel-Bucket deaktiviert.
