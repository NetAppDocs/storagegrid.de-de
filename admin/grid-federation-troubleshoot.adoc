...
+
image:grid-federation-retry-account-clone.png["Screenshot mit einer Fehlermeldung und der Schaltfläche Kontoklonen wiederholen"]Wenn der Fehler behoben wurde, wird das Mandantenkonto nun in das andere Grid geklont.
...
image:grid-federation-last-error.png["Screenshot mit einer Meldung in der Spalte Letzter Fehler einer Grid Federation-Verbindung"]
