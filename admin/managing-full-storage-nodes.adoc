...
summary: Sobald die Speicherkapazität der Speicherknoten erschöpft ist, muss das StorageGRID System durch Hinzufügen von neuem Speicher erweitert werden. Dies ist möglich durch das Hinzufügen von Speichervolumes, Speichererweiterungsgehäusen und Speicherknoten. 
---
