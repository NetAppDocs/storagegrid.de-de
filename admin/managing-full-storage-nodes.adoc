...
summary: 'Sobald die Speicherkapazität der Speicherknoten erschöpft ist, muss das StorageGRID System durch Hinzufügen von neuem Speicher erweitert werden. Hierfür stehen drei Optionen zur Verfügung: Hinzufügen von Speichervolumes, Hinzufügen von Speichererweiterungsregalen und Hinzufügen von Speicherknoten.' 
---
