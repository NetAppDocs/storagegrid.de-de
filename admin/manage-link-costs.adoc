...
image:link_costs.gif["Konzeptdiagramm für die Verknüpfung von Kosten zwischen Datacentern"]
...
+
image:configuring_link_costs.png["Verbindungskosten"]
...
+
Um Änderungen zu verwerfen, image:nms_revert.gif["Symbol rückgängig machen"]*Revert* auswählen.
