...
* Die Verbindungskosten werden vom Load Balancer-Dienst auf Admin-Knoten und Gateway-Knoten verwendet, um Clientverbindungen zu steuern. Siehe link:../admin/managing-load-balancing.html["Überlegungen zum Lastausgleich"].


Das Diagramm zeigt ein Grid mit drei Standorten, bei dem die Verbindungskosten zwischen den Standorten konfiguriert sind:

image:link_costs.png["Konzeptdiagramm für die Verknüpfung von Kosten zwischen Datacentern"]
...
. Für jede in der Spalte „Site/Link cost“ aufgeführte Site einen Kostenwert von 0 bis 100 für die anderen Sites eingeben.
+
...
+
** Zum Verwerfen von Änderungen *Änderungen löschen* auswählen.
