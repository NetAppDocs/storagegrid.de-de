...
NOTE: Zur Anzeige von Diagrammen dieser Werte die Diagrammsymbole in den Spalten „Verfügbar“ auswählen.
...
image:forecast_metadata_usage.png["Prognose der Metadatennutzung nach Standort"]
