...
---
= Alarmregeln in StorageGRID bearbeiten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alert_rules_edit_rule.png["Benachrichtigungen > Regel bearbeiten"]
...
+
image:alert_rules_edit_revert_to_default.png["Meldungsregeln: Zurücksetzen einer bearbeiteten Bedingung auf den Standardwert"]
