...
sidebar: sidebar 
keywords: ilm tab 
summary: 'Die Registerkarte ILM bietet Informationen zu Operationen des Information Lifecycle Management (ILM).' 
---
= Die StorageGRID ILM-Registerkarte anzeigen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_ilm_tab.png["Knoten Seite ILM Registerkarte"]
