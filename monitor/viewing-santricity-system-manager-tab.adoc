...
---
= Die Registerkarte StorageGRID SANtricity System Manager anzeigen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Um den SANtricity System Manager zur Konfiguration eines Proxys für E-Series AutoSupport zu verwenden, siehe link:sending-eseries-autosupport-messages-through-storagegrid.html["Senden Sie E-Series AutoSupport-Pakete über StorageGRID"].
...
image:nodes_page_santricity_tab.png["Knoten Seite SANtricity Registerkarte"]
