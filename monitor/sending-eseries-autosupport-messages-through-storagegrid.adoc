...
* Sie haben die link:../admin/admin-group-permissions.html["Zugriffsberechtigung für den Administrator der Storage-Appliance oder den Root-Zugriff"].
...
+
image:autosupport_santricity_home_page.png["Startseite von AutoSupport SANtricity"]
...
+
image:autosupport_santricity_operations.png["AutoSupport SANtricity AutoSupport Betrieb"]
...
+
image:autosupport_configure_delivery_santricity.png["AutoSupport konfigurieren AutoSupport-Bereitstellungsmethode SANtricity"]
