...
---
= Anzeigen und Verwalten des Dashboards in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_manager_dashboard.png["Grid Manager Dashboard"]
...
|===
Einige Karten können zur besseren Ansicht maximiert werden. Das Maximieren-Symbol image:icon_dashboard_card_maximize.png["Symbol maximieren"] befindet sich in der oberen rechten Ecke der Karte. Zum Schließen einer maximierten Karte kann das Minimieren-Symbol image:icon_dashboard_card_minimize.png["Symbol minimieren"] oder *Schließen* ausgewählt werden.
...
image:dashboard_manage.png["Managen von Dashboards"]
...
image:dashboard_configure.png["Dashboard konfigurieren"]
