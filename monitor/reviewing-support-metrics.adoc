...
---
= Überprüfen Sie die StorageGRID-Support-Metriken
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:metrics_page.png["Seite „Kennzahlen“"]

. Zum Abfragen der aktuellen Werte der StorageGRID-Metriken und zum Anzeigen von Diagrammen der Werte im Zeitverlauf den Link im Abschnitt Prometheus auswählen.
+
...
. Zum Zugriff auf vorgefertigte Dashboards mit Diagrammen der StorageGRID-Metriken im Zeitverlauf die Links im Abschnitt Grafana auswählen.
+
Die Grafana-Schnittstelle für den ausgewählten Link wird angezeigt.

+
image:metrics_page_grafana.png["Seite „Kennzahlen“ Grafana"]
