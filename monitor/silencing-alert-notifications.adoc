...
---
= Warnmeldungen in StorageGRID stummschalten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alerts_silences_page.png["Benachrichtigungen > Stummschaltungsseite"]
...
+
image:alerts_create_silence.png["Benachrichtigungen > Stille erstellen"]
