...
---
= Überwachen Sie StorageGRID Grid-Federation-Verbindungen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:grid-federation-connections-tab.png["Registerkarte „Netzverbundverbindungen“"]
...
+
image:grid-federation-permitted-tenants-tab.png["Registerkarte „Grid Federation Permitted Tenants“"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["Grid-Federation-allouned-Tenants-tab-for-connection"]
...
+
image:grid-federation-certificates-tab.png["Grid-Federation-Certificates-tab"]
