...
+
image:grid_federation_connections_tab.png["Registerkarte „Netzverbundverbindungen“"]
...
+
image:grid_federation_permitted_tenants_tab.png["Registerkarte „Grid Federation Permitted Tenants“"]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["Grid-Federation-allouned-Tenants-tab-for-connection"]
...
+
image:grid_federation_certificates_tab.png["Grid-Federation-Certificates-tab"]
