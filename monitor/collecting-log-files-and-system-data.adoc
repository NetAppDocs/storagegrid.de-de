...
---
= Sammeln Sie StorageGRID-Protokolldateien und Systemdaten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Wenn der Admin-Knoten, der zum Starten der Protokollerfassung verwendet wurde, während der Protokollerfassung offline geht, speichert StorageGRID die Ergebnisse nicht. Nach Abschluss des Neustarts ist der Knoten neu zu starten und die Protokollerfassung erneut zu starten.
...
NOTE: Sie können das Feld für die Provisioning Passphrase für einen Standard-Wiederholungsversuch leer lassen oder die Passphrase eingeben, um den Wiederholungsversuch per SSH durchzuführen.
