...
---
= Registerkarte „Dienste der StorageGRID-Plattform“ anzeigen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_site_level_platform_services.gif["Knoten Seiten Plattform-Services auf Standort-Ebene"]
