...
+
image:alerts_create_custom_rule.png["Benachrichtigungen > Benutzerdefinierte Regel erstellen"]
...
+
Um verfügbare Metriken anzuzeigen und Prometheus-Ausdrücke zu testen, das Hilfesymbol image:icon_nms_question.png["Fragezeichen-Symbol"] auswählen und dem Link zum Abschnitt Metriken der Grid Management API folgen.
