...
Weitere Informationen zur Syntax von Prometheus-Abfragen finden Sie unter  https://prometheus.io/docs/prometheus/latest/querying/basics/["Grundlagen der Abfrage"^].
...
+
image:nodes_page_network_traffic_graph.png["Prometheus Diagramm"]
