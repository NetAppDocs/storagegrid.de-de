...
---
= Systemzustand in StorageGRID überwachen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:health_status_card.png["Zustandskarte – Dashboard"]
...
Wenn eine oder mehrere Warnungen aktiv sind, <<Anzeige aktueller und aufgelöster Warnmeldungen,Wählen Sie jede Warnmeldung aus>> und befolgen Sie die empfohlenen Maßnahmen.
 ...
 a| 
image:icon_alert_green_checkmark.png["Symbol Warnung grünes Häkchen"]
 a| 
* Verbunden*
...
. Um Gruppen von Benachrichtigungen zu erweitern, wählen Sie den Pfeil nach unten image:icon_alert_caret_down.png["Nach unten fahrlässiges Symbol"]. Um einzelne Benachrichtigungen in einer Gruppe zu reduzieren, wählen Sie den Pfeil nach oben image:icon_alert_caret_up.png["Nach-oben-Symbol"] oder den Namen der Gruppe.
. Um einzelne Warnungen anstelle von Warengruppen anzuzeigen, deaktivieren Sie das Kontrollkästchen *Gruppenwarnungen*.
. Um aktuelle Benachrichtigungen oder Benachrichtigungsgruppen zu sortieren, die Auf-/Abwärtspfeile image:icon_alert_sort_column.png["Sortieren Sie das Symbol für die Pfeile"] in den jeweiligen Spaltenüberschriften auswählen.
+
...
.. Zum Schließen des Pop-ups kann eine beliebige Stelle außerhalb des Pop-ups ausgewählt werden.
