...
+
Das Plus-Symbol image:icon_plus_sign_black_on_white.gif["Plus-Symbol"] auswählen, um Empfänger hinzuzufügen.
...
NOTE: Wenn Sie die E-Mail-Einstellungen bearbeiten müssen, wählen Sie das Stiftsymbol image:icon_edit_tm.png["Symbol bearbeiten"] , um dieses Feld zu aktualisieren.
