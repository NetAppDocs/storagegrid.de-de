...
* Wenn Sie virtuelle Hosts verwenden, haben Sie vor der Konfiguration des Hostnetzwerks den gelesen<<mac_address_cloning_ubuntu,Überlegungen und Empfehlungen zum Klonen von MAC-Adressen>>.
