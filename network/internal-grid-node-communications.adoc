...
summary: 'Die StorageGRID interne Firewall lässt eingehende Verbindungen nur zu bestimmten Ports im Grid-Netzwerk zu, mit Ausnahme der Ports 22, 80, 123 und 443 (siehe Informationen zur externen Kommunikation). Verbindungen werden auch an Ports akzeptiert, die von Load-Balancer-Endpunkten definiert sind.' 
---
...
Appliances
 a| 
Primärer Admin Node und nicht-primärer Admin Node
 a| 
