...
summary: 'Ein Client-Netzwerk ist optional. Durch die Verwendung eines Client-Netzwerks kann der Client-Netzwerk-Traffic (beispielsweise S3) vom internen Grid-Traffic getrennt werden, sodass Grid-Netzwerke sicherer sind. Wenn das Admin-Netzwerk nicht konfiguriert ist, kann der administrative Datenverkehr entweder vom Client oder vom Grid-Netzwerk verarbeitet werden.' 
---
...
image:grid_client_networks.png["Grid Client-Netzwerke"]

image:grid_client_networks_ips.png["Grid Client Networks-IPs"]
