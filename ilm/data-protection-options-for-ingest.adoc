...
summary: Wenn eine ILM-Regel erstellt wird, können Objekte beim Ingest geschützt werden, indem entweder Dual commit, Strict oder Balanced angegeben wird. 
---
...
image:ingest_object_lifecycle.png["Diagramm, das die Objektaufnahme für die einzelnen Aufnahmeoptionen zeigt"]
