...
summary: 'Wenn Sie eine ILM-Regel erstellen, geben Sie eine von drei Optionen zum Schutz von Objekten bei der Aufnahme an: Dual commit, Strict oder Balanced.' 
---
