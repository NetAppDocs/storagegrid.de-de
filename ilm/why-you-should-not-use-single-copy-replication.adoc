...
image:ilm_replication_make_1_copy.png["ILM-Replizierung erstellen 1 Kopie"]
...
image:ilm_replication_make_1_copy_sn_fails.png["ILM-Replizierung erstellen 1 Kopie SN schlägt fehl"]
...
image:ilm_replication_make_2_copies_sn_fails.png["ILM-Replizierung Erstellen von 2 Kopien SN schlägt fehl"]
