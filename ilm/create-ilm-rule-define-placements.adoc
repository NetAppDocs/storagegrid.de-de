...
summary: 'Im Schritt „Platzierungen definieren“ des Assistenten „ILM-Regel erstellen“ können die Platzierungsanweisungen definiert werden, die festlegen, wie lange Objekte gespeichert werden, welche Art von Kopien (repliziert oder mit Erasure-Coding), der Speicherort und die Anzahl der Kopien.' 
---
...
image:ilm_create_ilm_rule_wizard_2.png["Assistent zum Erstellen einer ILM-Regel, Schritt 2"]
...
+
image:ilm_rule_retention_diagram.png["Diagramm zur Aufbewahrung von ILM-Regeln"]
