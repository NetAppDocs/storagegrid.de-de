...
image:ilm_replication_at_2_sites.png["Es wird jeweils 1 Kopie an 2 Standorten repliziert"]

image:ilm_replication_make_2_copies_2_pools_2_sites.png["Erstellen Sie 1 Kopie an jedem der 2 Standorte – standortspezifischer Speicherpool"]
...
image:ilm_erasure_coding_site_loss_protection_4+2.png["EC 1 Storage-Pool 9 Storage-Nodes 3 Standorte"]
...
image:ec_three_sites_4_plus_2_site_loss_example_template.png["Speichern Sie Objekte durch Erasure Coding mithilfe eines 4+2-EC-Schemas an 3 Standorten"]

Wenn ein Standort verloren geht, können die Daten immer noch wiederhergestellt werden:

image:ec_three_sites_4_plus_2_site_loss_example.png["Erasure Coding 4+2 EG-Schema 1 Standort verloren"]
