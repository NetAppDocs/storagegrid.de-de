...
image:ilm_rule_two_copies_two_data_centers.png["ILM-Regel 1, z. B. 1: Objektdaten an zwei Standorte kopieren"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["ILM-Regel 2 beispielsweise 1: Profil für Erasure Coding mit Bucket-Matching"]
...
+
image:policy_1_configured_policy.png["ILM-Richtlinie für Beispiel 1"]
