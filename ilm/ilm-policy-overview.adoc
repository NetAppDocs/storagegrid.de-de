...
summary: 'Eine Information Lifecycle Management-Richtlinie (ILM) ist ein bestellter Satz von ILM-Regeln, die bestimmen, wie das StorageGRID System Objektdaten über einen längeren Zeitraum managt.' 
---
...
image:ilm-policies-single.png["Einzelnes ILM-Richtliniendiagramm"]
...
image:ilm-policies-tags-conceptual.png["Diagramm mit mehreren ILM-Richtlinien"]
...
image:ilm_policy_and_rules.png["ILM-Richtlinie und -Regeln"]
