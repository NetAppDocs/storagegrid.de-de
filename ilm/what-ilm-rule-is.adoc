...
summary: 'Zum Managen von Objekten erstellen Sie eine Reihe von Regeln für das Information Lifecycle Management (ILM) und organisieren diese in eine ILM-Richtlinie.' 
---
...
image:ilm_rule_multiple_placements_in_single_time_period.png["Bildschirm ILM-Platzierungen im Grid Manager"]

Die erste Einstufungsanweisung image:icon_number_1.png["Symbol Nummer 1"] hat für das erste Jahr zwei Zeilen:
...
Die zweite Platzierungsanweisung image:icon_number_2.png["Symbol Nummer 1"] erstellt nach einem Jahr zwei Kopien und bewahrt diese Kopien dauerhaft auf.
