...
image:simulate_policy_screen.png["Richtlinienergebnisse simulieren"]
...
+
image:simulate_reorder_rules_pngs_result.png["Beispiel 2: Neuanordnung von Regeln bei der Simulation einer ILM-Richtlinie"]
...
+
image:simulate_reorder_rules_correct_result.png["Beispiel 2: Neuanordnung von Regeln bei der Simulation einer ILM-Richtlinie"]
...
image:simulate_results_for_object_wrong_metadata.png["Beispiel 3: Korrigieren von Regeln bei der Simulation einer ILM-Richtlinie"]
...
+
image:simulate_results_for_object_corrected_metadata.png["Beispiel 3: Korrigieren von Regeln bei der Simulation einer ILM-Richtlinie"]
