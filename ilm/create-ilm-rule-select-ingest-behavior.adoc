...
summary: 'Schritt 3 (Auswahl des Aufnahmeverhaltens) des Assistenten zum Erstellen einer ILM-Regel ermöglicht die Auswahl, wie die durch diese Regel gefilterten Objekte beim Eingang geschützt werden.' 
---
