...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["ILM-Regel 1 beispielsweise 3: Verwenden Sie EC für Bilddateien über 1 MB"]
...
image:policy_3_configured_policy.png["ILM-Richtlinie beispielsweise 3: Besserer Schutz für Image-Dateien"]
