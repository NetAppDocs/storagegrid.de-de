...
NOTE: Bei der Installation von StorageGRID 12.0 oder höher auf einem neuen Grid werden automatisch Speicherpools für jeden Standort erstellt. Wenn jedoch ursprünglich StorageGRID 11.6 oder eine frühere Version installiert wurde, werden Speicherpools nicht automatisch für jeden Standort erstellt.
...
+
Um einen Eintrag zu entfernen, das Löschsymbol image:icon_x_to_remove.png["Symbol Löschen"] auswählen.
