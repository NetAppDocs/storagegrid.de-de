...
NOTE: Bevor Sie einen Konsistenzwert auswählen, link:../s3/consistency.html["Lesen Sie die vollständige Beschreibung der Konsistenz"]. Vor dem Ändern des Standardwerts sollten Sie die Vorteile und Einschränkungen kennen.
