...
summary: Sie können einen Cloud Storage Pool bearbeiten, um seinen Namen, den Service-Endpunkt oder andere Details zu ändern, jedoch kann der S3-Bucket oder der Azure-Container für einen Cloud Storage Pool nicht geändert werden. 
---
