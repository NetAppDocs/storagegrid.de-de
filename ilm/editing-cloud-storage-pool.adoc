...
summary: Sie können einen Cloud Storage Pool bearbeiten, um seinen Namen, den Service-Endpunkt oder andere Details zu ändern. Der S3-Bucket oder der Azure-Container eines Cloud Storage Pools kann jedoch nicht geändert werden. 
---
