...
+
image:ilm_rule_details_page.png["Detailseite zu ILM-Regel"]
...
+
Sie können das Fragezeichen image:icon_nms_question.png["Fragezeichen-Symbol"] auswählen, um eine Beschreibung der Elemente auf der Registerkarte ILM anzuzeigen.

+
image:ilm_metrics_on_dashboard.png["ILM-Kennzahlen im Grid Manager Dashboard"]
