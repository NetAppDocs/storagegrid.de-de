...
== Anforderungen für die Aktivierung von S3 Object Lock auf bestehenden Buckets

Wenn die globale S3 Object Lock-Einstellung aktiviert ist, kann optional allen S3-Mandantenkonten oder S3-Benutzern mit Berechtigungen erlaubt werden, S3 Object Lock für bestehende Buckets zu aktivieren. Wenn ein S3-Mandantenkonto oder S3-Benutzer S3 Object Lock für einen bestehenden Bucket aktiviert, kann dies abhängig von Ihren ILM-Regeln zu einer unbeabsichtigten Datenmigration von einem Cloud Storage Pool zurück zu StorageGRID führen.


CAUTION: Eine unbeabsichtigte Datenmigration kann nach ihrem Beginn nicht mehr gestoppt werden.
