...
image:ilm_rule_apply_only_to_older_object_verions.png["Wenden Sie ILM-Regel nur auf ältere Objektversionen an (nicht aktuelle Zeit)."]
...
link:how-objects-and-delete-markers-are-deleted.html["Wie Objekte und Löschmarkierungen gelöscht werden"]
