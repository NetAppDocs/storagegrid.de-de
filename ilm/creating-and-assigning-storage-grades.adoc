...
+
.. Für jede benutzerdefinierte Speicherkategorie, die Sie hinzufügen möchten, *Einfügen* image:icon_nms_insert.gif["Symbol einfügen"] auswählen, um eine Zeile hinzuzufügen.
.. Geben Sie eine beschreibende Bezeichnung ein.
+
image:editing_storage_grades.gif["Seite „Speicherstufen“"]

.. Wählen Sie *Änderungen Anwenden*.
.. Optional: Falls eine gespeicherte Bezeichnung geändert werden muss, *Bearbeiten* image:icon_nms_edit.gif["Symbol bearbeiten"] auswählen und *Änderungen anwenden* wählen.
+
...
+
.. Den Speicherknoten in der LDR-Liste suchen und dessen *Bearbeiten*-Symbol image:icon_nms_edit.gif["Symbol bearbeiten"] auswählen.
.. Wählen Sie den entsprechenden Speichergrad aus der Liste aus.
+
image:assigning_storage_grades_to_storage_nodes.gif["Seite „Speicherstufen“"]
