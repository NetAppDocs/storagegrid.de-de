...
image:ec_three_sites_4_plus_2.png["Verfahren Zur Einhaltung Von Datenkonsistenz An Drei Standorten 4 Plus 2"]
...
image:ec_recoverable_4_plus_2.png["Erasure Coding Wiederherstellbar 4 Plus 2"]

Wenn mehr als zwei Speicherknoten verloren gehen, kann das Objekt nicht abgerufen werden.

image:ec_unrecoverable_4_plus_2.png["Erasure Coding Nicht Behebbar 4 Plus 2"]
