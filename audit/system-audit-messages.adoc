...
summary: 'Die Audit-Meldungen, die zur Systemauditkategorie gehören, werden für Ereignisse im Zusammenhang mit dem Überwachungssystem selbst, Grid-Node-Status, systemweiter Aufgabenaktivität (Grid-Aufgaben) und Service-Backup-Vorgängen verwendet.' 
---
= Auditmeldungen für Systemereignisse in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
