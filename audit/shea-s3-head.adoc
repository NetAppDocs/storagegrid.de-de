...
summary: Wenn ein S3-Client einen HEAD-Vorgang ausgibt, wird eine Anforderung gestellt, die Existenz eines Objekts oder Buckets zu prüfen und die Metadaten über ein Objekt abzurufen. Diese Meldung wird vom Server ausgegeben, wenn der Vorgang erfolgreich war. 
---
= SHEA: S3 KOPF
:allow-uri-read: 
:icons: font
...
[role="lead"]
Wenn ein S3-Client einen HEAD-Vorgang ausgibt, wird eine Anforderung gestellt, die Existenz eines Objekts oder Buckets zu prüfen und die Metadaten über ein Objekt abzurufen. Diese Meldung wird vom Server ausgegeben, wenn der Vorgang erfolgreich war.
