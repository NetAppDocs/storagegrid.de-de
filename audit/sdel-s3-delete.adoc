...
---
= SDEL-Revisionsprotokollnachricht für S3 DELETE-Transaktionen in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
ASRS
 a| 
URN der angenommenen Rollensitzung
 a| 
Die eindeutige Kennung der angenommenen Rollensitzung.

Nur vorhanden, wenn die S3-Anfrage temporäre Sicherheitsanmeldeinformationen aus einer AssumeRole-Anfrage verwendet.
...
ASRU
 a| 
Angenommene Rolle URN
 a| 
Die eindeutige Kennung der übernommenen Rolle.
