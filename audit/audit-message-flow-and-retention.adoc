...
image:audit_message_flow.gif["Diagramm mit der Zusammenfassung des Meldungsflusses durch Relais"]
...
image:audit_message_retention.gif["Diagramm mit der Zusammenfassung des Belegs der Prüfmeldung am AMS"]
