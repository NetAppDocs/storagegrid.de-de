...
summary: 'Diese Meldung wird immer dann generiert, wenn kein Speicherort für eine Objektkopie (repliziert oder mit Erasure-Codierung) gefunden werden kann.' 
---
= LLST-Revisionsprotokollmeldung für verlorene Objektkopiespeicherorte in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
