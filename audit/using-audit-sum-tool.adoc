...
summary: 'Mit dem Tool audit-sum können die Audit-Meldungen für Schreiben, Lesen, Head und Löschen gezählt sowie die minimale, maximale und durchschnittliche Zeit (oder Größe) für jeden Operationstyp angezeigt werden.' 
---
