...
summary: Die LKDM Audit-Meldung wird generiert, wenn ein durchgesickerter Chunk bereinigt oder gelöscht wurde. 
---
= LKDM-Revisionsprotokollmeldung zur Bereinigung von geleakten Objekten in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
