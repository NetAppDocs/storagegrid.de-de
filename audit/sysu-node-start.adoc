...
summary: 'Wenn ein Dienst neu gestartet wird, wird diese Meldung erzeugt, um anzugeben, ob die vorherige Abschaltung sauber (befahl) oder ungeordnet (unerwartet) war.' 
---
= SYSU-Revisionsprotokollnachricht für Knotenstarts in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
