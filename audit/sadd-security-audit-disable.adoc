...
summary: 'Diese Meldung weist darauf hin, dass der Ursprungsdienst (Knoten-ID) die Protokollierung von Audit-Meldungen deaktiviert hat. StorageGRID erfasst und übermittelt keine Audit-Meldungen mehr.' 
---
= SADD-Revisionsprotokollmeldung zur Deaktivierung der Sicherheitsprüfung in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Diese Meldung weist darauf hin, dass der Ursprungsdienst (Knoten-ID) die Protokollierung von Audit-Meldungen deaktiviert hat. StorageGRID erfasst und übermittelt keine Audit-Meldungen mehr.
