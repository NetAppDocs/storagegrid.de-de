...
summary: 'Diese Meldung wird erzeugt, wenn ein externer (Client-angeforderter) Vorgang ein Objekt durch ein anderes Objekt überschrieben.' 
---
= OVWR-Revisionsprotokollmeldung für Objektüberschreibungen in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
