...
---
= Erstellen Sie ein Mandantenkonto für FabricPool in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Optional kann *Grid-Federationsverbindung verwenden* ausgewählt werden, um dem Mandanten die Nutzung einer link:../admin/grid-federation-overview.html["Netzverbundverbindung"] für die Kontosynchronisierung und gridübergreifende Replikation zu ermöglichen. Anschließend wird die zu verwendende Grid-Federationsverbindung ausgewählt.
