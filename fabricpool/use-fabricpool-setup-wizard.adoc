...
---
= Erfahren Sie mehr über den StorageGRID FabricPool Einrichtungsassistenten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Wenn Sie S3-Anfragen im Virtual-Hosted-Style verwenden möchten, haben Sie link:../admin/configuring-s3-api-endpoint-domain-names.html["Domänennamen des S3-Endpunkts wurden konfiguriert"]. ONTAP verwendet standardmäßig URLs im Path-Style, jedoch wird die Verwendung von Virtual-Hosted-Style-Anfragen empfohlen.
