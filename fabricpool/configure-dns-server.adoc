...
== DNS-Einträge für virtual-hosted-style Anfragen

Wenn link:../admin/configuring-s3-api-endpoint-domain-names.html["Domänennamen des S3-Endpunkts"] definiert wurde und Anfragen im virtual-hosted-style verwendet werden, sind DNS-Einträge für alle erforderlichen S3-Endpunkt-Domänennamen, einschließlich etwaiger Wildcard-Namen, hinzuzufügen.
