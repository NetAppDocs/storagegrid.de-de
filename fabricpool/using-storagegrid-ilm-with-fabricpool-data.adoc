...
* Wenn Sie StorageGRID von einer StorageGRID Version vor 11.7 auf 12.1 aktualisiert haben, haben Sie den Speicherpool, den Sie verwenden werden, konfiguriert. Im Allgemeinen sollte für jeden StorageGRID Standort, der zur Datenspeicherung verwendet wird, ein Speicherpool erstellt werden. (Ab Version 11.7 werden Speicherpools automatisch für jeden Standort erstellt.)
+
