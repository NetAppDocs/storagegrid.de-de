...
---
= Löschen eines StorageGRID S3 bucket
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Ein S3-Bucket kann nicht gelöscht werden, wenn er Objekte, nicht aktuelle Objektversionen oder Löschmarkierungen enthält. Informationen darüber, wie S3-versionierte Objekte gelöscht werden, finden sich unter link:../ilm/how-objects-and-delete-markers-are-deleted.html["Wie Objekte und Löschmarkierungen gelöscht werden"].
