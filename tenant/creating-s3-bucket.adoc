...
---
= Erstellen Sie einen StorageGRID S3-Bucket
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Wenn mehrere Mandanten jeweils bis zu 5.000 Buckets haben, verfügt jeder Storage Node im Grid über mindestens 64 GB RAM.
+

NOTE: Das StorageGRID System unterstützt maximal 20.000 Buckets pro S3-Tenant-Konto. Jedes Grid kann maximal 100.000 Buckets enthalten, einschließlich link:../tenant/what-is-branch-bucket.html["Zweigeimer"]. Es gibt außerdem eine Begrenzung für link:../tenant/manage-branch-buckets.html["Branch-Bucket-Tiefe"].
...
Weitere Informationen sind im  https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html["Dokumentation der Amazon Web Services (AWS) zu den Bucket-Benennungsregeln"^] zu finden.
