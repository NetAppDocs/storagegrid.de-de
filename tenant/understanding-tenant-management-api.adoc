...
---
= Erfahren Sie mehr über die StorageGRID Tenant Management API
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* *s3-configurations*: Vorgänge zum Abrufen globaler S3-Konfigurationen.
...
image:tenant_api_swagger_example.gif["Beispiel für DIE FUNKTION GET Groups in Swagger API"]
