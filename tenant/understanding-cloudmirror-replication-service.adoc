...
---
= Erfahren Sie mehr über den StorageGRID CloudMirror Replikationsdienst
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: CloudMirror Replikation wird nur unterstützt, wenn für den Quell-Bucket die S3 Object Lock-Funktion aktiviert ist und der Endpunkt ein Amazon oder StorageGRID S3 Bucket ist. Object Lock-Einstellungen werden nicht an den Bucket-Endpunkt repliziert.
