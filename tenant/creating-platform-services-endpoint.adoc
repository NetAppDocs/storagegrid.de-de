...
|===
--
.Webhook und Kafka Endpunkte
--
Die TLS-Verbindung für Webhook- oder Kafka-Endpunkte wird überprüft.
...
*Hinweis*: Webhook-Endpunkte verfügen nicht über diese Option.
