...
image:grid-federation-account-clone-workflow-tm.png["Der Workflow des Mandanten für den Kontoklon. Die Schritte werden im folgenden Text beschrieben."]
...
image:grid-federation-account-clone.png["Bild, das zeigt, dass lokale Gruppen vom Quell- zum Zielraster geklont werden"]
...
image:grid-federation-local-user-clone.png["Bild, das zeigt, dass lokale Benutzer vom Quell- zum Zielraster geklont werden"]
...
image:grid-federation-federated-group-clone.png["Abbildung, die zeigt, dass föderierte Gruppen vom Quell- zum Zielraster geklont werden"]
...
image:grid-federation-s3-access-key.png["Abbildung, die zeigt, dass s3-Zugriffsschlüssel optional vom Quell- zum Zielraster geklont werden können"]
...
image:grid-federation-account-not-cloned.png["Bild, das zeigt, dass Details im Zielraster nicht im Quellraster geklont werden"]
...
image:grid-federation-account-clone-edit-delete.png["Bild, das zeigt, dass bearbeitete oder gelöschte Details nicht geklont werden"]
