...
---
= Erfahren Sie mehr über StorageGRID Branch-Buckets
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Sie speichern Daten in einem versionierten Bucket. Es gab eine versehentliche Schwachstelle, die dazu führte, dass zwischen den Zeitpunkten _T1_ und _T2_ viele unerwünschte Objekte aufgenommen wurden. Es kann ein Branch-Bucket für die auszuschließenden Zeitwerte _T1_ und _T2_ erstellt und Client-Operationen an diesen Branch-Bucket umgeleitet werden. So werden Clients nur Objekte bereitgestellt, die vor _T1_ und nach _T2_ aufgenommen wurden.
...
Siehe auch link:../ilm/how-objects-and-delete-markers-are-deleted.html#delete-s3-versioned-objects["Löschen von S3-versionierten Objekten"].
