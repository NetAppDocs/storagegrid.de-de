...
---
= Konfigurieren Sie die CloudMirror-Replikation in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Die Replikation wird nur für Quell- oder Ziel-Buckets unterstützt, bei denen die S3 Object Lock-Funktion für Amazon S3 oder StorageGRID S3-Buckets aktiviert ist. Die Object Lock-Header werden nicht auf das Zielobjekt repliziert.
...
* Wenn Sie die S3-Objektsperre für den Ziel-Bucket aktivieren, nachdem Sie die CloudMirror-Replikation konfiguriert haben, müssen Sie möglicherweise link:../tenant/editing-platform-services-endpoint.html["den Endpunkt erneut speichern"] zulassen, damit die Replikation fortgesetzt werden kann.
