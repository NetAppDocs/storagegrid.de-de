...
---
= Tenant Manager Dashboard in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:tenant_dashboard_with_buckets.png["Dashboard – Bucket-Liste"]
...
+
image:tenant_dashboard_storage_usage_segment.png["Balkendiagramm Segment"]
...
+
image:tenant_dashboard_buckets.png["Mandanten-Dashboard-Buckets"]
...
image:tenant_dashboard_endpoint_error.png["Dashboard mit Endpunkt-Meldung"]
