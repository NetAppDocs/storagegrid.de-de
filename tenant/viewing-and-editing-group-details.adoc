...
---
= Details zu Mandantengruppen in StorageGRID anzeigen und bearbeiten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:tenant_group_details.png["Gruppendetails Anzeigen"]
...
+
.. Optional kann der Anzeigename ausgewählt oder das Bearbeitungssymbol image:icon_edit_tm.png["Symbol bearbeiten"] verwendet werden, um den Anzeigenamen zu aktualisieren.
+
