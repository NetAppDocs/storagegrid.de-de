...
Wenn die globale S3 Object Lock-Einstellung für ein StorageGRID-System aktiviert ist, kann ein S3-Mandantenkonto Buckets mit oder ohne aktivierte S3 Object Lock-Funktion erstellen. Wenn die Einstellung „S3 Object Lock für bestehende Buckets zulassen“ aktiviert ist, kann ein S3-Mandantenkonto S3 Object Lock für einen bestehenden Bucket aktivieren. Wenn für einen Bucket S3 Object Lock aktiviert ist, ist die Bucket-Versionierung erforderlich und wird automatisch aktiviert. Nachdem ein S3-Mandantenkonto S3 Object Lock für einen neuen oder bestehenden Bucket aktiviert hat, kann diese Einstellung nicht mehr deaktiviert werden.
...
Erfahren Sie mehr überlink:../ilm/requirements-for-s3-object-lock.html#s3-object-lock-existing-buckets["Anforderungen an die S3-Objektsperre"]
