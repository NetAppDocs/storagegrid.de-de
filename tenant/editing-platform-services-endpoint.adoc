...
---
= Bearbeiten Sie einen Platform Services-Endpunkt in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Um den Anzeigenamen für den Endpunkt zu ändern, das Bearbeitungssymbol image:icon_edit_tm.png["Symbol Bearbeiten"] auswählen.
