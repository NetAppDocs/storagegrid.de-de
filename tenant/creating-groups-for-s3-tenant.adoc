...
+
Wenn Ihr Mandantenkonto über die Berechtigung *Grid-Verbundverbindung verwenden* verfügt und Sie sich im Quell-Grid des Mandanten befinden, wird die neue Gruppe mit dem Ziel-Grid des Mandanten synchronisiert. *Erfolgreich* erscheint als Synchronisierungsstatus im Abschnitt „Übersicht“ auf der Detailseite der Gruppe.
