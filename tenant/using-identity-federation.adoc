...
image:tenant_shares_identity_federation.png["Mandanten Teilen Sich Die Identitätsföderation"]
...
+
image:ldap_service_type.png["Seite „Identity Federation“ mit Optionen für LDAP-Diensttypen"]
...
+
image:identity_federation_test_connection.png["Identity Federation fordert zur Validierung des BIND-Benutzernamens-Formats auf"]
