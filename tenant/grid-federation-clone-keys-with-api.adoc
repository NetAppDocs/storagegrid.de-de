...
+
image:grid_federation_post_current_user_replicate.png["POST-Endpunkt für die Replikation des eigenen Zugriffsschlüssels"]
...
+
image:grid_federation_clone_access_key.png["Die Mandanten-Manager-API gibt Werte zum Klonen des Zugriffsschlüssels ein"]
...
+
image:grid_federation_post_other_user.png["POST-Endpunkt zur Replikation des Zugriffsschlüssels eines anderen Benutzers"]
