...
---
= Konfigurieren Sie Ereignisbenachrichtigungen in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Bestätigen Sie, dass eine Benachrichtigung an das Zielthema Amazon SNS, Kafka-Thema oder den Webhook-Endpunkt übermittelt wurde.
+
