...
---
= Objektversionierung für einen S3-Bucket in StorageGRID ändern
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../ilm/how-objects-and-delete-markers-are-deleted.html["Wie Objekte und Löschmarkierungen gelöscht werden"]
