...
---
= Objekte aus einem StorageGRID S3-Bucket löschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Wenn für einen Bucket die Objektversionierung aktiviert ist, werden beim Löschen von Objekten keine Löschmarkierungen entfernt, die in StorageGRID 11.7 oder früher erstellt wurden. Informationen zum Löschen von Objekten in einem Bucket befinden sich in link:../ilm/how-objects-and-delete-markers-are-deleted.html#delete-s3-versioned-objects["Löschen von S3-versionierten Objekten"].
...
+
image:delete_bucket_objects_in_progress.png["Screenshot mit den zu löschenden Bucket-Objekten"]
...
+
image:delete_bucket_objects_complete.png["Screenshot mit allen gelöschten Bucket-Objekten"]
