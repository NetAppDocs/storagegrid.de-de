...
+
image:delete-bucket-objects-in-progress.png["Screenshot mit den zu löschenden Bucket-Objekten"]
...
+
image:delete-bucket-objects-complete.png["Screenshot mit allen gelöschten Bucket-Objekten"]
