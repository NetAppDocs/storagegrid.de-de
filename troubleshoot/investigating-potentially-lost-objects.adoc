...
summary: Wenn die Warnung „Objekte möglicherweise verloren“ ausgelöst wird, müssen Sie dies unverzüglich untersuchen. Sammeln Sie Informationen zu den betroffenen Objekten und wenden Sie sich an den technischen Support. 
---
= Beheben Sie die Warnung „Objekte möglicherweise verloren“ in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Der technische Support bittet Sie möglicherweise, zu prüfen, ob ein Storage-Wiederherstellungsverfahren läuft. Weitere Informationen finden Sie unter:
