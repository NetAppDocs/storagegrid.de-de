...
---
= Beheben Sie die Warnung zur Wasserzeichenüberschreibung in StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_object_data_used_with_alert.png["Seite Knoten mit Objektdaten, die für 3 SNS verwendet werden"]
