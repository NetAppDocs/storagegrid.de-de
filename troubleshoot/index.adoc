...
* link:../monitor/manually-triggering-autosupport-package.html["Starten Sie manuell ein AutoSupport-Paket"]
...
[cols="1a,2a,4a"]
|===
| image:feature_checkmark.gif["Häkchen"] | Element | Hinweise 
